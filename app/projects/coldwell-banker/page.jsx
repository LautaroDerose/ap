...
import backgroundImage1 from '../../../public/banker-context-001.png'
import backgroundImage2 from '../../../public/banker-context-002.png'
import backgroundImage3 from '../../../public/banker-context-003.png'
...
export default function Coldwell() {
  return(
    <div>
      ...
      <div className='flex'>
        <div className='w-4/12 h-[30vh] border-r-2 border-b-2 '>
          ...
          <div className='flex h-full items-center justify-center relative z-20'>
            <h1 className='text-6xl font-bold group-hover:text-black duration-300'>{mock[2].label}</h1>
          </div>
        </div>
        <div className='w-8/12 h-[30vh] flex justify-center border-b-2 '>
          <div className='w-4/12 '>
            <Image src={backgroundImage2} layout="" objectFit="" className="h-full object-cover" />
          </div>
          <div className='w-4/12'>
            <Image src={backgroundImage1} layout="" objectFit="" className="h-full object-cover" />
          </div>
          <div className='w-4/12'>
            <Image src={backgroundImage3} layout="" objectFit="" className="h-full object-cover" />
          </div>
        </div>
      </div>
