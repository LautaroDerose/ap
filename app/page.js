...
import backgroundImage from '../public/jeep-context-001.png'
...
export default function Home() {
  ...
  const labelClass = "px-4 py-2 border-white border-2 rounded-full hover:bg-white hover:text-black font-light  duration-300 "
  ...
  return (
    <main className="flex min-h-screen flex-col items-center ">
      ...
      <div className="h-[50vh] w-full flex flex-col items-center justify-center relative">
        <div className='text-8xl font-semibold z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
          <h1>APRES.<span className='text-8xl font-extralight'>productora</span></h1>
          <div className='flex flex-col items-center mt-8 '>
            <div className='flex gap-4 items-center justify-center mb-2'>
              <h2 className='text-sm border-r-2 p-2'>Eventos y experiencias</h2>
              <h2 className='text-sm'>Producciones 360</h2>
              <h2 className='text-sm border-l-2 p-2'>Activaciones BTL</h2>
            </div>
              <h2 className='text-sm flex items-center'>Based in Patagonia  <Link href={"/"} className='ml-2 '> |  Contact us!</Link></h2>
          </div>
        </div>
      ...
      <div className="w-screen flex h-auto border-2 border-white">
          <div className='w-4/12 border-r-2 border-b-2 relative group'>
            <Image src={backgroundImage} layout="fill" objectFit="cover" className="z-0" />
          ...
          <div className='w-8/12 py-6 px-10 border-b-2'>
            <h1 className={`w-fit mx-auto text-6xl text-center border-b-4 mt-4 mb-4 ${work.className}`}>EXPERIENCIA JEEP GLADIATOR</h1>
            <p className='pt-4'>En medio de la majestuosidad natural de la ruta de los 7 lagos, nos aventuramos hacia nuestro destino final en el <a className='uppercase border-b-2 '>@lagohermososki</a>, donde la naturaleza se despliega en su máximo esplendor. Cada curva nos presenta una nueva sorpresa, con vistas impresionantes que cautivan nuestros sentidos y nos invitan a explorar más allá de lo conocido. Es un viaje donde la aventura se entrelaza con la belleza, creando recuerdos que perdurarán en nuestro corazón.</p>
            <h2>Feat: <a>@btlandia</a></h2>
          </div>
        </div>
      ...
      <div className="w-screen flex h-auto ">
        <div className='flex h-fit '>
          <div className='w-8/12 py-6 px-10 border-b-2'>
            <h1 className={`w-fit mx-auto text-6xl text-center border-b-4 mt-4 mb-4 uppercase ${work.className}`}>Lanzamiento de Producto</h1>
            <p className='pt-4'>Celebramos el lanzamiento de  <a className='uppercase border-b-2 '>@bosquegin</a> en Villa La Angostura con un vibrante after lake. La música y los DJs en vivo acompañaron la degustación de este gin tan patagónico y sus aromáticas notas. Sumergidos en la atmósfera de los lagos, los invitados exploraron los sabores únicos mientras se deleitaban con la majestuosidad natural que rodea cada momento de esta experiencia inolvidable.</p>
            {/* <h2>Feat: <a>@btlandia</a></h2> */}
          </div>
          <div className='w-4/12   border-l-2  border-b-2'>
            <div className='flex h-full items-center justify-center'>
              <h1 className='text-8xl font-bold'>{mock[1].label}</h1>
            </div>
          </div>
        </div>
